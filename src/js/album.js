...
const album = albumData.find(a => a.idx === idx); // Busca el álbum en albumData que coincide con el ID obtenido de la URL
...
if (album) { // Si se encuentra el álbum, procede a crear y mostrar la información
    ...
    for (let i = 0; i < album.songs.length; i++) {
        ...
        if (song.note) { // Verifica si la canción tiene una nota vinculada a ésta
